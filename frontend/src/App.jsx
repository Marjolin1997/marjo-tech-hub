...
import NetworkSpeedTestPage from './features/network-test/NetworkSpeedTestPage.jsx';
import './features/network-test/NetworkSpeedTestPage.css';
import ProfilePage from './features/profile/ProfilePage.jsx';
import SecurityRiskCenterPage from './features/security-center/SecurityRiskCenterPage.jsx';
...
function ToolboxFallback(){return <div style={{maxWidth:1240,margin:'0 auto',padding:'48px 24px'}}><Card><Skeleton active paragraph={{rows:6}}/></Card></div>}
function ToolboxRoute(){return <ProtectedRoute><Suspense fallback={<ToolboxFallback/>}><ToolboxPage/></Suspense></ProtectedRoute>}

export default function App(){return <Routes><Route path="/login" element={<LoginPage/>}/><Route path="/forgot-password" element={<ForgotPasswordPage/>}/><Route path="/reset-password" element={<ResetPasswordPage/>}/><Route path="/accept-invitation" element={<AcceptInvitationPage/>}/><Route path="/verify-2fa" element={<TwoFactorPage/>}/><Route path="/network-test" element={<NetworkSpeedTestPage/>}/><Route path="/" element={<ProtectedRoute><Workspace/></ProtectedRoute>}/><Route path="/services" element={<ProtectedRoute><PermissionRoute permission="services.view"><ServicesPage/></PermissionRoute></ProtectedRoute>}/><Route path="/services/:id" element={<ProtectedRoute><PermissionRoute permission="services.view"><ServiceDetailPage/></PermissionRoute></ProtectedRoute>}/><Route path="/documents" element={<ProtectedRoute><PermissionRoute permission="documents.view"><DocumentsPage/></PermissionRoute></ProtectedRoute>}/><Route path="/messages" element={<ProtectedRoute><PermissionRoute permission="messages.view"><MessagingPage/></PermissionRoute></ProtectedRoute>}/><Route path="/activity" element={<ProtectedRoute><PermissionRoute permission="activity.view"><ActivityPage/></PermissionRoute></ProtectedRoute>}/><Route path="/git-handbook" element={<ProtectedRoute><GitHandbookPage/></ProtectedRoute>}/><Route path="/toolbox" element={<ToolboxRoute/>}/><Route path="/toolbox/:toolId" element={<ToolboxRoute/>}/><Route path="/security-center" element={<ProtectedRoute><SecurityRiskCenterPage/></ProtectedRoute>}/><Route path="/profile" element={<ProtectedRoute><ProfilePage/></ProtectedRoute>}/><Route path="/access-control" element={<ProtectedRoute><PermissionRoute permission="users.view"><AccessControlPage/></PermissionRoute></ProtectedRoute>}/><Route path="*" element={<Navigate to="/" replace/>}/></Routes>}
